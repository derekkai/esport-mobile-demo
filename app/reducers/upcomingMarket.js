...
const SET_UPCOMING_MARKET_DATA = `${prefix}/SET_UPCOMING_MARKET_DATA`;
const CLEAR_UPCOMING_MARKET_DATA = `${prefix}/CLEAR_UPCOMING_MARKET_DATA`;
const UPDATE_UPCOMING_MARKET_DATA = `${prefix}/UPDATE_UPCOMING_MARKET_DATA`;
    ...
    switch (action.type) {
      case SET_UPCOMING_MARKET_DATA: {
        ...
        Object.values(action.payload.market).forEach(market => {
          pushIdBySort(action.payload.market, market, keys[0].value, 'id');
