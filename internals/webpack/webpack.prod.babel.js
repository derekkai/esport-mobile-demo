...
module.exports = require('./webpack.base.babel')({
  ...
  output: {
    filename: 'static-h5/[name].[chunkhash].js',
    chunkFilename: 'static-h5/[name].[chunkhash].chunk.js',
  },
  ...
  plugins: [
    ...
    new WebpackPwaManifest({
      name: 'esport-h5',
      short_name: 'esport-h5',
      description: 'yaudian esport h5',
